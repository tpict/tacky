...
export function screen(...expressions: unknown[]): MediaType | MediaTypeExpression {
...
export function print(...expressions: unknown[]): MediaType | MediaTypeExpression {
  if (expressions.length === 0) {
...
export function speech(...expressions: unknown[]): MediaType | MediaTypeExpression {
  if (expressions.length === 0) {
